...
import { OilRigOffshoreIcon, WellIcon } from '@tecton/react/icons';
import { CompassIcon, LayoutDashboardIcon, MaximizeIcon, PaintBucketIcon, SearchIcon } from 'lucide-react';
 ...
 * colouring, commands and workspaces (panels, data, settings and help are on
 * the rail at the left of the stage, see `workspace/Rail.tsx`). As the window
  ...
  return (
    <>
      ...
      <Overflow role="group" aria-label="View and commands" className="min-w-0 flex-1 flex-nowrap justify-end gap-1">
        ...
        <OverflowSpacer />
        {/* panels, data, settings and help are on the rail at the left of the stage */}
        <Tools app={app} />
        <GroupDivider />
