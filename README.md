...
- **Overlays** in 3D (log curtain, oil–water contact, uncertainty cones, the geosteering band) are rows of the Scene tree's **Overlays** folder: the eye shows or hides one (hidden, it computes nothing), and selecting it shows its settings (curve, σ, contact plane…) in **Properties**. Closing the Geosteering window leaves its band in 3D; its eye hides both.
